    ...
    >
      <template #header="{ collapsed: isCollapsed }">
        <div class="flex items-center gap-2 px-2 py-1">
          ...
          />
          <span v-if="!isCollapsed" class="font-semibold text-sm truncate">
            Financials Tracker
          </span>
        </div>
      </template>
      ...
      <template #default="{ collapsed: isCollapsed }">
        <UDashboardSearchButton :collapsed="isCollapsed" class="mb-1" />
        <UNavigationMenu
      ...
      <template #footer="{ collapsed: isCollapsed }">
        <div class="flex items-center gap-2 p-2">
          ...
          <span v-if="!isCollapsed" class="text-sm text-muted truncate flex-1">
            Admin
          </span>
          <UButton
            v-if="!isCollapsed"
